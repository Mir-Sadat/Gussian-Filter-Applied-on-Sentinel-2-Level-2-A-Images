...
output_folder = os.path.join(tif_folder, "filtered")
...
for idx, filename in enumerate(tif_files):
    ...
    # Apply Gaussian filter band-wise and compute SSIM
    ...
    # Save filtered image
    output_path = os.path.join(output_folder, filename.replace(".tif", "_filtered.tif"))
